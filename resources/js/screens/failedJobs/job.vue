    ...
    export default {
        ...
        methods: {
            loadFailedJob(id) {
                ...
                this.$http.get(Horizon.basePath + '/api/horizon/jobs/failed/' + id)
                    .then(response => {
             ...
             */
            reloadRetries() {
                this.$http.get(Horizon.basePath + '/api/horizon/jobs/failed/' + this.$route.params.jobId)
                    .then(response => {
            ...
            retry(id) {
                ...
                this.$http.post(Horizon.basePath + '/api/horizon/jobs/retry/' + id)
                    .then(() => {
                        setTimeout(() => {
                            this.reloadRetries();

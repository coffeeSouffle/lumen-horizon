    ...
    export default {
        ...
        methods: {
            ...
            loadTags() {
                ...
                this.$http.get(Horizon.basePath + '/api/horizon/monitoring')
                    .then(response => {
            ...
            monitorNewTag() {
                ...
                this.$http.post(Horizon.basePath + '/api/horizon/monitoring', {'tag': this.newTag})
                    .then(response => {
             ...
             */
            stopMonitoring(tag) {
                this.$http.delete(Horizon.basePath + '/api/horizon/monitoring/' + encodeURIComponent(tag))
                    .then(() => {

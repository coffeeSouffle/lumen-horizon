<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
             ...
             */
            loadStats() {
                return this.$http.get(Horizon.basePath + '/api/horizon/stats')
                    .then(response => {
             ...
             */
            loadWorkers() {
                return this.$http.get(Horizon.basePath + '/api/horizon/masters')
                    .then(response => {
             ...
             */
            loadWorkload() {
                return this.$http.get(Horizon.basePath + '/api/horizon/workload')
                    .then(response => {
